...
public class DatabaseInitializer {
    ...
    private static void createTables(Statement stmt) throws SQLException {
        ...
        stmt.execute( "CREATE TABLE IF NOT EXISTS Datos (" +
                ...
                "COD_Indicador VARCHAR(20) REFERENCES Indicadores(COD), " +
                "Fecha BIGINT NOT NULL, " +
                "FK_TipoDato INT NOT NULL, " +
                "FK_Periodo INT NOT NULL, " +
                "Anyo INT NOT NULL, " +
                "Valor DOUBLE PRECISION NOT NULL, " +
                "Secreto BOOLEAN NOT NULL" +
                ");");
        stmt.execute("CREATE TABLE IF NOT EXISTS Indicadores (" +
                "COD VARCHAR(20) PRIMARY KEY, " +
                "Nombre TEXT NOT NULL, " +
                "FK_Unidad INT NOT NULL, " +
                "FK_Escala INT NOT NULL" +
                ")");
