...
public class RepositoryFactory {
    ...
    public static <T> T getRepository(Class<T> repositoryClass) {
        T errorCreatingRepository = (T) repositories.computeIfAbsent(repositoryClass, RepositoryFactory::apply);
        return errorCreatingRepository;
    }

    private static Object apply(Class<?> key) {
        try {
